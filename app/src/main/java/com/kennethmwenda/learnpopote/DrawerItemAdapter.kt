...
//    private lateinit var drawerItemList:List<DrawerItemModel<*>>
//    private var viewTypes:HashMap<Class<? : DrawerItemModel<*>>, Int>
//    private lateinit var holderFactories:SparseArray<DrawerItemModel<*>>
//
//    fun DrawerAdapter (drawerItemsList:List<DrawerItemModel<*>>){
//        this.drawerItemList = drawerItemsList
